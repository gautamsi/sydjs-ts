...
const meetupStateEnum: any = new GraphQLEnumType({
    name: "MeetupState",
...
const rsvpType: any = new GraphQLObjectType({
    name: "RSVP",
    fields: {
...
const organisationType: any = new GraphQLObjectType({
    name: "Organisation",
    fields: () => ({
...
function modelFieldById(objectType: any, keystoneModel: any) {
...
const queryRootType = new GraphQLObjectType(<any>{
    name: "Query",
    fields: {
        node: nodeField,
        ...
        allMeetups: {
            ...
            resolve: (_: any, { state, ...args }: any) => connectionFromPromisedArray(
        ...
        allTalks: {
            type: talkConnection,
            args: connectionArgs,
            resolve: (_: any, args: any) => connectionFromPromisedArray(
